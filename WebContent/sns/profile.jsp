...
<button style="background-color:#0288d1" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
 Unfriend
</button>&nbsp&nbsp<button style="background-color:#0288d1" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
  Message
</button></div></div>
